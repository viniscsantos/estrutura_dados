...
bool Stack::isFull() const {
 ...
 /*
 Adicionar um novo item no topo da pilha. O nó que acabamos de criar deve apontar para quem estava no topo da pilha e o ponteiro
...
/*Devolve o objeto que está no topo da pila.
*/
ItemType Stack::pop(){
    if(!isEmpty()){
        NodeType* tempPtr;
